...
async function createFile(message: String, url: String): Promise<void> {
  try {
    console.log("url: ", url); //------------------------------------------------------------------------------------------
...
async function readMessage(filePath: PathLike): Promise<void> {
  try {
...
export async function logger(req: Request, res: Response, next: NextFunction) {
  console.log("log: before 'if message exists'"); //------------------------------------------------------------------------------------------
